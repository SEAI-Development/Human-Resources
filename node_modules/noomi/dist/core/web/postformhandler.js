...
exports.PostFormHandler = void 0;
...
class PostFormHandler {
    ...
    handleBuf(buf) {
        ...
        let ind = buf1.indexOf(this.boundary);
        if (ind !== -1) { // 有分隔符
            // 循环处理所有数据项
                ...
                if (this.valueStarted) { // 上一帧值已经开始，尚未传完
                    ...
                    if (this.isFile) { // 文件
                        if (this.value['fileName']) {
                            application_1.App.fs.writeFileSync(this.value['path'], buf2, { flag: 'a+' });
                        }
                    }
                    else { // 普通串
            ...
            if (this.isFile) { // 文件
                if (this.buf && this.value['fileName']) {
                    // 直接把当前buf写文件
                    application_1.App.fs.writeFileSync(this.value['path'], this.buf, { flag: 'a+' });
                }
        ...
        if (arr.length > 2) { // 文件
            for (let i = 2; i < arr.length; i++) {
                ...
                if (s.startsWith('filename=')) {
                    ...
                    const fn2 = application_1.App.uuid.v1() + fn1.substring(fn1.lastIndexOf('.'));
                    // 得到绝对路径
                    const filePath = util_1.Util.getAbsPath([this.saveDir, fn2]);
                    this.value = {
                        fileName: fn1,
                        path: filePath
                    };
...
exports.PostFormHandler = PostFormHandler;
//# sourceMappingURL=postformhandler.js.map