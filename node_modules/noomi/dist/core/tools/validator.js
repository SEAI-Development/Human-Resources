...
class Validator {
     ...
     * @param validatorName -
     */
    static hasValidator(validatorName) {
     ...
     */
    static validate(name, value, ...paramArr) {
