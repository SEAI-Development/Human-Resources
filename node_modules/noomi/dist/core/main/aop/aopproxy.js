...
class AopProxy {
     ...
     */
    static invoke(clazz, methodName) {
        ...
        if (util.types.isAsyncFunction(func)) {
            return async function (...args) {
                const instance = instancefactory_1.InstanceFactory.getInstance(clazz);
                //advices获取
                let advices;
                if (aopfactory_1.AopFactory) {
                    advices = aopfactory_1.AopFactory.getAdvices(clazz, methodName);
                }
                const aopParams = {
                    //类
                    clazz: clazz,
        ...
        return function (...args) {
            const instance = instancefactory_1.InstanceFactory.getInstance(clazz);
            //advices获取
            const advices = aopfactory_1.AopFactory.getAdvices(clazz, methodName);
            const aopParams = {
                methodName: methodName,
                params: args,
                returnValue: undefined,
